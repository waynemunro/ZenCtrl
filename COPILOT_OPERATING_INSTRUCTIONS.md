...
8. **Version Control:**
   ...
   * Branching strategy should align with `COPILOT_WORKING_PRINCIPLES.md`.

9. **Tool Usage & Context:**
...
10. **Continuous Improvement:**
    ...
    * Regularly review and incorporate feedback to enhance the effectiveness of the "gamified strategy execution."

## Communication Style

* **Clarity and Conciseness:** Provide clear and to-the-point explanations for suggestions and actions.
* **Proactive Suggestions:** Offer proactive suggestions that align with the strategic objective and iterative development principles.
* **Narrative Alignment:** Frame suggestions and explanations within the "windfall through gamified strategy execution" narrative where appropriate and helpful.

## Prompt Logging

* Key interactions, complex instructions, and their outcomes will be summarized in `DEVELOPMENT_LOG.md` by the user or as prompted, to ensure a traceable decision path, especially noting how they contribute to the "octagon stage" performance.

## Adherence

* Strict adherence to these operating instructions is expected to maximize the probability of achieving the "windfall." Deviations should be explicitly discussed and agreed upon.
